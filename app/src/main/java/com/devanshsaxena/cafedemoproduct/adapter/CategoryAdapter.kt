...
import com.devanshsaxena.cafedemoproduct.activity.CategoryActivity
import com.devanshsaxena.cafedemoproduct.databinding.LayoutCategoryItemBinding
...
class CategoryAdapter (var context : Context, val list : ArrayList<CategoryModel>) : RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CategoryViewHolder, position: Int) {
        ...
        Glide.with(context).load(list[position].cate).into(holder.binding.imageView)
