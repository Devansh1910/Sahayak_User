...
import com.devanshsaxena.cafedemoproduct.databinding.LayoutProductItemBinding
...
class ProductAdapter (val context: Context,val list: ArrayList<AddProductModel>) : RecyclerView.Adapter<ProductAdapter.ProductViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ProductViewHolder, position: Int) {
        ...
        holder.binding.textView3.text =  data.productSp
        holder.binding.servicename.text = data.productMrp
